export const en = {
  ...
  questionnaire: {
    ...
    fields: {
      ...
      trial_duration: "Trial Operation Duration",
      responsible_person: "Person Responsible for Acceptance",
      ...
      geo_replication: "Geographic Replication",
